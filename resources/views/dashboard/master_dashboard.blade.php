...
<head>
  ...
  <title>@yield('title') | LICT CONTENT MANAGEMENT ADMIN</title>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/4.0.0-9/css/ionicons.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{route('dashboard.index')}}" class="logo">
      ...
      <span class="logo-mini"><b>LICT</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>LICT</b>Admin</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="{{route('dashboard.index')}}">LICT</a>.</strong> All rights reserved.
  </footer>
